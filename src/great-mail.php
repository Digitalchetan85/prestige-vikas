...
try {
    ...
    $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'New Messages from Prestige City Website The Great Acres page';
        $mail->Body    = '<html><body>';
        ...
        $mail->Body   .= "<tr><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['great-name']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['great-email']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['great-phone']) . "</td></tr>";
        $mail->Body   .= "</table>";
        $mail->Body   .= "</body></html>";
