...
try {
    ...
    $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'New Messages from Prestige City Website Avalon Park page';
        $mail->Body    = '<html><body>';
        ...
        $mail->Body   .= "<tr><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['avalon-name']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['avalon-email']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['avalon-phone']) . "</td></tr>";
        $mail->Body   .= "</table>";
        $mail->Body   .= "</body></html>";
